...
export const CLASSES: Record<ClassId, ClassDef> = {
  ...
  paladin: {
    ...
    base: { hp: 116, mp: 38, atk: 12, def: 11, mag: 10, res: 10, spd: 9, move: 4, jump: 2 },
    growth: { hp: 12, mp: 4, atk: 1.8, def: 1.6, mag: 1.2, res: 1.3, spd: 0.6 },
  ...
  berserker: {
    ...
    base: { hp: 126, mp: 12, atk: 17, def: 8, mag: 2, res: 4, spd: 10, move: 4, jump: 2 },
    growth: { hp: 13, mp: 1, atk: 2.6, def: 1.0, mag: 0.2, res: 0.5, spd: 0.8 },
  ...
  ninja: {
    ...
    base: { hp: 84, mp: 30, atk: 13, def: 7, mag: 9, res: 8, spd: 15, move: 5, jump: 3 },
    growth: { hp: 8, mp: 3, atk: 1.8, def: 0.8, mag: 1.0, res: 0.9, spd: 1.3 },
